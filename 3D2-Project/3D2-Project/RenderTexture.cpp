...
bool RenderTexture::Initialize(ID3D11Device* device, int textureWidth, int textureHeight, float screenDepth, float screenNear)
{
	...
	// create Render target view desc
	...
	D3DXMatrixPerspectiveFovLH(&m_projectionMatrix, D3DX_PI * 0.25f, textureWidth / textureHeight, screenNear, screenDepth);

 	D3DXMatrixOrthoLH(&m_orthoMatrix, textureWidth, textureHeight, screenNear, screenDepth);
}
